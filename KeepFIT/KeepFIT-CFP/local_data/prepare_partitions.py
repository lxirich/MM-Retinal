...
def adequate_30_sustech():
    ...
    data_c5 = pd.read_csv(PATH_DATASETS + path_dataset + image_subpath + "c5_DR_reclassified.csv")                # 新增的标签 类5
...
def MM_Retinal_dataset():
    ...
    subpath_images = ["CFP"]
    # subpath_images = ["CFP/", "FFA/"]             # 当前只管CFP
    ...
    for iSub in subpath_images:
        ...
        for iFile in range(dataframe.shape[0]):
            ...
            image_path = path_dataset + iSub + "/" + id       # 无后缀
